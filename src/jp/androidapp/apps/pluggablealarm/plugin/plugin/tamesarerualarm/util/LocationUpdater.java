...
public class LocationUpdater {
    ...
    /**
     * GPSまたは基地局電波やWiFiなどにより、現在地を検測する
     * 現在地確認用TextView無し版
     * @param context
     */
     ...
     * @param context
     */
    public LocationUpdater(Context context, TextView targetText){
        mLM = (LocationManager)context.getSystemService(Activity.LOCATION_SERVICE);
    ...
    public void onResume(){
        ...
        mLM.requestLocationUpdates(LocationManager.GPS_PROVIDER, updateMinTime, updateMinDist, mGPSListener);
    }
